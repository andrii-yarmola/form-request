...
var app, base, concat, directory, gulp, gutil, hostname, path, refresh, sass, uglify, imagemin, minifyCSS,
    jade, del, browserSync, autoprefixer, gulpSequence, shell, sourceMaps, plumber, iconfont;
...
gulp.task('default', ['mock', 'browserSync', 'scripts', 'styles'], function() {
